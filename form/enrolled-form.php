<?php
    ...
    $view_sql4 = "SELECT * FROM patient_enrollement WHERE patient_id = :patient_id";
    $patient_enrolled = $controller->getPatientById($view_sql4, $patient_id);
    //print_r($patient_enrolled);
    if($patient_enrolled){
        $user_fetch_id = $patient_enrolled->users_id;
